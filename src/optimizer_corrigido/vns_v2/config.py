...
from optimizer_corrigido.vns.config import *          # noqa: F401,F403
from optimizer_corrigido.vns.config import (           # re-exporta explicitamente p/ o solver
...
# reinícios. Com T_MULT=1.0 o piso efetivo caía para 180s — IGUAL ao orçamento
