...
"""
============================================================================
 solver.py — GVNS for the Behavioral SPSP (search + full transparency)
============================================================================
...
def solve_vns(file_path, t_limit_override=None, show_console=True):
    ...
    out_dir = os.path.join("data", "results_v2", "vns", name)   # modelo corrigido → results_v2
    ...
    log.console(f"   Saida: {out_dir}/allocations.csv, "
                f"convergence_log.csv, vnd_log.csv, debug_log.txt, "
                f"constraints_report.txt")
    log.close()
